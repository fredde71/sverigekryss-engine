export function getNextCell({
  ...
  if (Array.isArray(clueSelection?.answerCellIndexes)) {
    const pathIndex = clueSelection.answerCellIndexes.indexOf(currentIndex);
    if (pathIndex >= 0) {
      return clueSelection.answerCellIndexes[pathIndex + 1];
    }
  }
